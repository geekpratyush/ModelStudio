import { Box, Workflow, Database, ArrowRight, Zap, Shield, Layout, Layers } from 'lucide-react';
    ...
    <div className="landing-container" data-theme="dark">
      ...
      <header className="hero-section">
        <div className="hero-content">
          ...
          <p>
            The ultimate visual workspace for Domain-Driven Design, Enterprise Camel Patterns, 
        ...
        <div className="hero-visual">
          ...
          <div className="visual-card eip-card">
            <Workflow size={32} color="var(--accent-orange)" />
            <span>EIP Camel Routes</span>
          </div>
          <div className="visual-card arch-card">
            <Layout size={32} color="var(--accent-blue)" />
